...
Original file is located at
    https://colab.research.google.com/drive/1CmAj15FEHrsdRr-J1Foswdp9NRetxtFY
...
for i in range(1, 6):
    copy_among_buckets(from_bucket='nyc-tlc',
                       ...
                       to_key=f'i-0bbb90023e67ae7ee{i}.parquet')
...
def copy_among_buckets(from_bucket, from_key, to_bucket, to_key):
    ...
    s3.Object(to_bucket, to_key).copy_from(CopySource=copy_source)
...
จำนวน rides มากน้อยเท่าไร และมีค่าโดยสารรวมของ rides และจ านวนผู้โดยสารเฉลี่ยต่อ 
